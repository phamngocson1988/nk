...
#return_content .table>tbody>tr>td, .table>tbody>tr>th, .table>tfoot>tr>td, .table>tfoot>tr>th, .table>thead>tr>td, .table>thead>tr>th{ padding: 3px;vertical-align: middle !important;
    padding: 8px !important;
    text-align: center; }
#return_content table td{
	vertical-align: top !important;
    padding: 8px !important;
    text-align: center;
...
#return_content table tbody{

	background-color: #f1f5f6;
}
#return_content table tbody tr td{
	 border: 1px solid #fff !important;
	 color: #484848;
	 font-size: 14px;
...
label{text-align: right;margin-top:7px;}
.lable_phone_new{
    position: absolute;
    top: 7px;
    right: 10px;
