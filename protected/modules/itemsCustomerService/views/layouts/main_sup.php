...
<div class="row wrapper tab-content full-height">
   ...
   <div  id="profileSideNav"  class="span1 primary-navbar col-sm-2 col-md-1">
       <ul class="nav nav-tab nav-stacked" id="myTab">
            <li id="profile_preview_nav" class="<?php if($controller == 'reportingTreatmentAfter') echo "active"; ?>">
                <a href="<?php echo $baseUrl; ?>/itemsCustomerService/reportingTreatmentAfter/View" >
                    <img src="<?php echo $baseUrl;?>/images/icon_sb_left/1_tong_quan/kinh_doanh_<?php if($controller == 'reportingTreatmentAfter'){ echo "act"; }else{ echo 'def'; } ?>.png" /> <br>
...
<script type="text/javascript">
    ...
    function resizeWindows() {
      ...
      $('#treatmentListContainer').height(windowHeight-header-oSrchBar-125);
    }
</script>
