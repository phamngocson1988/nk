...
<page backtop="15mm" backbottom="5mm" backleft="10mm" backright="10mm" format="Letter" backcolor="#fff" style="font: arial;font-family:freeserif ; margin-top:50px;">
	<p style="text-align: center;font-size: 20px;">DANH SÁCH KHÁCH HÀNG THEO NGÀY ĐIỀU TRỊ CUỐI CÙNG</p>
	 	...
	 	<table class="ivDt">
		  	<thead >
		  		<tr>
		  			...
		  			<th style="width: 8%">Ngày điều trị cuối cùng</th>				 					
		  		</tr>
		  	</thead>
		  	<tbody>
		  	<?php 
		  	...
		  	?>
		  		<tr class="sort-field">
		  			...
		  			<td style="width: 8%"><?php echo $value['last_day']; ?></td>
		  		</tr>
		  	<?php } ?>
