...
<form class="form-inline">
    <div id="oSrchRight" class="pull-left">
        ...
        <div class="form-group" style="margin-right:20px;">
              ...
              <?php
                    ...
                    echo CHtml::dropDownList('frm_search_due_requester_date',3,$listdata,array('onChange'=>"search_cus(this);",'class'=>'form-control'));
 ...
 -->
    ...
    <div id="oSrchLeft" class="pull-right" style="text-align: right;">
        <!-- Split button -->
        <div class="btn-group">
          <button type="button" class="btn btn_bookoke" onclick="detailreport()"><i class="fa fa-search-plus"></i>&nbsp;Xem</button>
...
<script>
    function search_report(selectObject){
        ...
        if (value == 0)
            ...
            window.location.assign("<?php echo CController::createUrl('ReportingCustomer/DateTreatment')?>");
...
$( document ).ready(function() {
    ...
    $('#oSrchBar').on('click','.print',function(e){
        ...
        var id_user         = $("#frm_search_user_id").val();
        var location        = $("#frm_search_branch").val();
         var url="<?php echo CController::createUrl('ReportingCustomer/printreport')?>?location="+location+"&id_user="+id_user+"&time="+time;
...
$( document ).ready(function() {
    ...
    $('#oSrchBar').on('click','.pdf',function(e){
       var time            = $("#frm_search_due_requester_date").val();
        ...
        var url="<?php echo CController::createUrl('ReportingCustomer/exportPDF_Appointment')?>?type="+type+"&branch="+branch+"&lstUser="+lstUser+"&search_time="+search_time;
        window.open(url,'name');
