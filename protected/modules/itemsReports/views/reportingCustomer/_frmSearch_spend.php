...
<form class="form-inline">
 ...
 -->
    ...
    <div id="oSrchLeft" class="pull-right" style="text-align: right;">
        <!-- Split button -->
        <div class="btn-group">
          <button type="button" class="btn btn_bookoke" onclick="detailreportdate_spend()"><i class="fa fa-search-plus"></i>&nbsp;Xem</button>
...
<script>
    ...
    function detailreportdate_spend(){     
    ...
    $.ajax({
        type:'POST',
        url: "<?php echo CController::createUrl('ReportingCustomer/DetailReportspend')?>", 
        data: {             time        :  time,
                            id_user     :  id_user,
                            location    :  location,
                            date        :  date,
