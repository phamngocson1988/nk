...
<form class="form-inline">
    <div id="oSrchRight" class="pull-left">
        ...
        <div class="form-group" style="margin-right:25px;">
            <label>Loại: </label>
             <?php 
                ...
                $listdata['0'] = "Báo cáo tình hình bán hàng";
                $listdata['1'] = "Tóm lược giao dịch";
                $listdata['2'] = "Hóa đơn chi tiết";
                $listdata['3'] = "Hóa đơn chưa thanh toán";
                echo CHtml::dropDownList('frm_search_type','',$listdata,array('onChange'=>"search_cus(1);",'class'=>'form-control','style'=>'width: 250px;'));
            ?>
        </div>
        ...
        <div class="form-group">
            <button class="btn btn_bookoke" id="xembaocao">Xem báo cáo</button>
        </div>
    </div>
