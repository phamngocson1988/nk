    ...
    <div id="oSrchRight" class="pull-left">
        <div class="form-group" style="margin-right:20px;">
            <label>Loại: </label>
             <?php 
                ...
                $listdata['0'] = "Theo ngày tạo";
                $listdata['3'] = "Theo ngày điều trị";
        ...
        <div class="form-group" style="margin-right:20px;">
              ...
              <?php 
                    ...
                    echo CHtml::dropDownList('frm_search_due_requester_date',5,$listdata,array('class'=>'form-control'));
        ...
        <div class="form-group">
            ...
            <span id="lstStaff">
                <?php 
                $sch = CsSchedule::model()->status_arr;
                echo CHtml::dropDownList('frm_search_schedule_status', '', $sch, array('class'=>'form-control', 'empty' => 'Tất cả', 'multiple' => 'multiple')); 
                ?>
            </span>
...
<script type="text/javascript">
    $('#frm_search_due_requester_date').change(function () {
        if ($(this).val() == 5) {
    ...
    $(document).ready(function(){
        //search_cus();
        $('#frm_search_schedule_status').multiselect({
             buttonWidth: '100px',
        });

        $('.multiselect').css('color', 'black');
    });
     ...
     function search_cus()
    {
        ...
        var schedule_status = $('#frm_search_schedule_status').val();

        if (schedule_status) {
            schedule_status = schedule_status.toString();
        }
...
$( document ).ready(function() {
    ...
    $('#oSrchBar').on('click','.print',function(e){      
        ...
        var url="<?php echo CController::createUrl('reportingAppointment/exportAppointment')?>?type="+type+"&branch="+branch+"&lstUser="+lstUser+"&search_time="+search_time+"&fromtime="+fromtime+"&totime="+totime+"&status="+schedule_status;
...
$( document ).ready(function() {
    ...
    $('#oSrchBar').on('click','.pdf',function(e){  
       ...
       if(search_time==5){
        ...
        var url="<?php echo CController::createUrl('reportingAppointment/exportPDF_Appointment')?>?type="+type+"&branch="+branch+"&lstUser="+lstUser+"&search_time="+search_time+"&fromtime="+fromtime+"&totime="+totime+"&status="+schedule_status;
        window.open(url,'name');
