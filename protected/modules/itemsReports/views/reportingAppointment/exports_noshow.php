	 	...
	 	<table class="ivDt">
		  	<thead >
		  		<tr>
		  			...
		  			<th style="width: 7%;"><strong>Văn phòng</strong></th>
		  	...
		  	<tbody>
				...
				<?php foreach ($export_appointmentList as $key => $v): ?>
					<tr>
						...
						<td style="width:5%;"><?php echo $v['fullname'];?></td>
						<td style="width:5%;"><?php echo $v['name_dentist'];?></td>
						<td ><?php echo date_format(date_create($v['start_time']),'d-m-Y'); ?></td>
						<td ><?php echo date_format(date_create($v['end_time']),'d-m-Y'); ?></td>
