        ...
        <div class="form-group" style="margin-right:25px;">
            <label>Loại: </label>
             <?php 
                ...
                $listdata['2'] = "Dự báo";
                echo CHtml::dropDownList('frm_search_type','',$listdata,array('onChange'=>"search_cus(1);",'class'=>'form-control','style'=>'width: 230px;'));
            ?>
        </div>
        ...
        <div class="form-group" style="margin-right:25px;">
            <label>Văn Phòng: </label>
              <?php 
                $listdata     = array();
                $listdata[""] = "Tất cả";
                echo CHtml::dropDownList('frm_search_office','',$listdata,array('class'=>'form-control')); 
            ?>
        </div>
...
<!-- 
<div class="report-control-container" style="margin-top: 30px;">
    <div class="rg-constrained control-box">
        <div class="report-controls" style="padding-left:0px;">
            <a class="btn btn-xs btn-success" href="javascript:void(0)" onclick="$find('rptViewer').exportReport('PDF');"><i class="fa fa-print"></i>&nbsp;Print</a>
        </div>

        <div class="report-controls">
            <a class="btn btn-xs " href="javascript:void(0)" onclick="$find('rptViewer').exportReport('EXCELOPENXML');"><i class="fa fa-file-excel-o"></i>&nbsp;Excel</a>
        </div>

        <div class="report-controls">
            <a class="btn btn-xs " href="javascript:void(0)" onclick="$find('rptViewer').exportReport('WORD');"><i class="fa fa-file-word-o"></i>&nbsp;Word</a>
        </div>

        <div class="report-controls">
            <a class="btn btn-xs " href="javascript:void(0)" onclick="$find('rptViewer').exportReport('PDF');"><i class="fa fa-file-pdf-o"></i>&nbsp;PDF</a>
        </div>

        <div class="report-controls">
            <a class="btn btn-xs " href="javascript:void(0)" onclick="$find('rptViewer').exportReport('CSV');"><i class="fa fa-file-o"></i>&nbsp;CSV</a>
        </div>

        <div class="report-controls">
            <a class="btn btn-xs" href="javascript:void(0)" onclick="refresh()">&nbsp;<i class="fa fa-refresh"></i>&nbsp;</a>
        </div>
        <div class="clearfix"></div>
    </div>
</div> -->
