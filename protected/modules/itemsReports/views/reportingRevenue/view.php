<style type="text/css">
	...
	.divtrangthai .multiselect-container{
		overflow: unset;
		height: auto;
	}
</style>
...
<div class="row" style="margin-top: 10px;">
	<div id="search">
		...
		<div class="col-md-2 divtrangthai" style="display: none">
			...
			<br>
			<?php $status=array("0"=>"Thanh Toán","1"=>"Còn nợ","2"=>"Phòng khám chuyên","3"=>"hoàn trả","4"=>"Delay","5"=>"Nhận","6"=>"Chuyển");?>
			<select class="form-control trangthai"  multiple="multiple">
	...
	function search_data() {
		...
		if (option!=-1) {
			...
			if (option == 2) {
				jQuery.ajax({
					type:"POST",
					url:"<?php echo CController::createUrl('reportingRevenue/RevenueReport')?>",
					data:{
						fromtime:fromtime,
						totime:totime,
				...
				jQuery.ajax({
					type:"POST",
					url:"<?php echo CController::createUrl('reportingRevenue/ShowRevenue')?>",
					data:{
						fromtime:fromtime,
						totime:totime,
						dentist:dentist,
			...
			jQuery.ajax({
				type:"POST",
				url:"<?php echo CController::createUrl('ReportingRevenue/ShowDetailRevenue')?>",
				data:{
					fromtime:fromtime,
					totime:totime,
					dentist:dentist,
