...
<?php $this->beginContent('//layouts/layouts_extension'); ?>
...
<div class="row wrapper tab-content full-height">
   ...
   <div  id="profileSideNav"  class="span1 primary-navbar col-sm-2 col-md-1">
       <ul class="nav nav-tab nav-stacked" id="myTab">
            ...
            <li id="profile_configure_nav" class="<?php if($controller == 'extensionCall') echo "active"; ?>">
                <a href="<?php echo $baseUrl; ?>/itemsCall/ExtensionCall/View">
