...
<div id="box_title_content" class="clearfix">
            <label class="col-xs-12 col-sm-6 col-md-9"><h3>Product Line Manager</h3></label>
            <div class="col-xs-12 col-sm-6 col-md-3 form-actions text-right">
                ...
                <?php echo CHtml::link('Create',array('ProductLine/create'),array('class'=>'margin-top-10 btn btn-success')); ?>
            </div>
        </div>
        <div class="col-md-6 col-lg-4 clearfix">
		<?php //echo $form->dropDownListGroup($model,'id_product_type',array('widgetOptions'=>array('data'=>CHtml::listData(ProductType::model()->findAll(),'id', 'name'),'htmlOptions'=>array('empty'=>'--Choose Product Type--','required'=>'required')))); ?>
