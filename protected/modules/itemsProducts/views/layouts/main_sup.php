...
<link id="settingCss" rel="stylesheet" type="text/css" href="<?php echo $baseUrl; ?>/css/gettimely.css" />
...
<div class="row wrapper tab-content full-height">
   ...
   <div  id="profileSideNav"  class="span1 primary-navbar col-sm-2 col-md-1">
       <ul class="nav nav-tab nav-stacked" id="myTab">    
        <?php if($group_id==3 || $group_id==17){ ?>
             <li id="profile_preview_nav" class="<?php if($controller == 'material') echo "active"; ?>">
                <a href="<?php echo Yii::app()->baseUrl.'/itemsProducts/Material/View'; ?>">
                    <img src="<?php echo $baseUrl;?>/images/icon_sb_left/6_hang_hoa/nguyen-vat-lieu-<?php if($controller == 'material'){ echo "act"; }else{ echo 'def'; } ?>.png" /> <br>
                    Nguyên vật liệu
                </a>
            </li> 
        <?php }else{ ?>
            <li id="profile_preview_nav" class="<?php if($controller == 'priceBook') echo "active"; ?>">
                <a href="<?php echo Yii::app()->baseUrl.'/itemsProducts/PriceBook/admin'; ?>">
                    <img src="<?php echo $baseUrl;?>/images/icon_sb_left/6_hang_hoa/bang-gia-<?php if($controller == 'priceBook'){ echo "act"; }else{ echo 'def'; } ?>.png" /> <br>
                    Bảng Giá
                </a>
            </li> 

            <li id="profile_preview_nav" class="<?php if($controller == 'productService') echo "active"; ?>">
                <a href="<?php echo Yii::app()->baseUrl.'/itemsProducts/ProductService/View'; ?>">
                    <img src="<?php echo $baseUrl;?>/images/icon_sb_left/6_hang_hoa/dich-vu-<?php if($controller == 'productService'){ echo "act"; }else{ echo 'def'; } ?>.png" /> <br>
                    Dịch Vụ
                </a>
            </li>  
            
            <li id="profile_preview_nav" class="<?php if($controller == 'product') echo "active"; ?>">
                <a href="<?php echo Yii::app()->baseUrl.'/itemsProducts/Product/Show'; ?>">
                    <img src="<?php echo $baseUrl;?>/images/icon_sb_left/6_hang_hoa/san-pham-<?php if($controller == 'product'){ echo "act"; }else{ echo 'def'; } ?>.png" /> <br>
                    Sản phẩm
                </a>
            </li>
              

            <li id="profile_preview_nav" class="<?php if($controller == 'packages') echo "active"; ?>">
                <a href="<?php echo Yii::app()->baseUrl.'/itemsProducts/Packages/View'; ?>">
                    <img src="<?php echo $baseUrl;?>/images/icon_sb_left/6_hang_hoa/tron-goi-<?php if($controller == 'packages'){ echo "act"; }else{ echo 'def'; } ?>.png" /> <br>
                    Trọn Gói 
                </a>
            </li>
			...
			<li id="profile_preview_nav" class="<?php if($controller == 'excelService' && $action == 'View') echo "active"; ?>">
                <a href="<?php echo Yii::app()->baseUrl.'/itemsProducts/ExcelService/View'; ?>">
                    <i class="glyphicon glyphicon-copy" aria-hidden="true"></i>
                    Nhập dịch vụ
                </a>
            </li>
			<li id="profile_preview_nav" class="<?php if($controller == 'excelService' && $action == 'View2') echo "active"; ?>">
                <a href="<?php echo Yii::app()->baseUrl.'/itemsProducts/ExcelService/View2'; ?>">
                    <i class="glyphicon glyphicon-copy" aria-hidden="true"></i>
                    Nhập nhóm dịch vụ
                </a>
            </li>
