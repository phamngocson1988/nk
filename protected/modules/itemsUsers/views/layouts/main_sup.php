...
<div class="row wrapper tab-content full-height">
   ...
   <div  id="profileSideNav"  class="span1 primary-navbar col-sm-2 col-md-1">
       <ul class="nav nav-tab nav-stacked" id="myTab">    
            ...
            <li id="profile_preview_nav" class="<?php if($controller == 'staff') echo "active"; ?>">
                <a href="<?php echo Yii::app()->baseUrl.'/itemsUsers/Staff/View'; ?>">
                    <img src="<?php echo $baseUrl;?>/images/icon_sb_left/4_khach_hang/khach_hang_<?php if($controller == 'staff'){ echo "act"; }else{ echo 'def'; } ?>.png" /> <br>
                   Nhân viên
                </a>
            </li>   
       </ul>
