...
<div id="content_tab_information" style="overflow: auto;" class="col-sm-12">
	<form method="post" role="form" id="form_data_user" name="form_data_user" enctype="multipart/form-data" class="row" style="margin-top: 20px;width: 100%">
		...
		<div class="col-sm-12">
			...
			<div class="col-sm-2">
				<input id="btn_save_user" value="Lưu Lại" type="submit" name="btn_save_user" style="width: 70px;height: 35px;background: #10b1dd;color: #fff;border-radius: 3px;padding: 3px 8px;font-size: 15px;border: solid 1px #D7D7D7;">
				</input>
			</div>
		</div>
		<div class="col-sm-12" id="rowHS" style="margin-top: 30px">
			...
			<div class="col-sm-8">
				<input class="input-form" type="text" id="code" name="code" value="<?php echo $model['code']; ?>">
			</div>
		</div>
		<div class="col-sm-12" id="rowHS" style="">
			<div class="col-sm-2 lable">
		...
		<div class="col-sm-12 password" id="rowHS">
			...
			<div class="col-sm-8">
				...
				<span onclick="change_pass()" style="color: #10b1dd;margin-top: 10px;cursor: pointer;">Đổi mật khẩu</span>
			</div>
		</div>
		<div id="update_password" style="display: none;">
			<div class="col-sm-12" id="rowHS" style="<?php if(Yii::app()->user->getState('group_id') == 1) echo "display: none;"; ?>">
				<div class="col-sm-2 lable">
					<label>Mật khẩu cũ:</label>
				</div>
				<div class="col-sm-8">
					<input class="input-form" type="password" id="pass_old" name="pass_old" onchange="enterPassOld()" value="">
			...
			<div class="col-sm-12" id="rowHS">
				...
				<div class="col-sm-8">
					<input class="input-form" type="password" id="pass_new" name="pass_new" onchange="<?php if(Yii::app()->user->getState('group_id') != 1) echo "enterPassNew()"; ?>" value="">
					<span onclick="cancel_update_pass()" style="color: #10b1dd;margin-top: 10px;cursor: pointer;<?php if(Yii::app()->user->getState('group_id') != 1) echo "display: none;"; ?>">Hủy</span>
				</div>
		...
		<div class="col-sm-12" id="rowHS">
			...
			<div class="col-sm-3">
				<?php  $branch = Branch::model()->findAll(); ?>
				<select class="input-form" id="branch_user" name="branch_user">			
					<?php for($i=0 ; $i < count($branch) ; $i++){ ?>
						<option <?php if($branch[$i]['id'] == $model->id_branch){ echo "selected"; } else { echo ""; } ?> value="<?php echo $branch[$i]['id'] ?>"><?php echo $branch[$i]['name'] ?></option>
					<?php } ?>
				</select>
			</div>
		</div>
		...
		<div class="col-sm-12" id="rowHS">
				<div class="col-sm-2 lable">
					<label>Đặt lịch online:</label>
				</div>
				<div class="col-sm-3">
				<?php $array_book = array('Có','Không'); ?>
					<select class="input-form" id="book_user" name="book_user">
						<?php for ($i=0; $i <= 1; $i++) {
							// if($model['block'] == $i){
						?>
						<option value="<?php echo $i; ?>"><?php echo $array_book[$i]; ?></option>
						<?php } ?>
					</select>
				</div>
		</div>
			...
			<div class="col-sm-8">
				<div class="example">
                    <select name="list_service[]" id="example-enableClickableOptGroups-disabled" multiple="multiple">
                         ...
                         {
                         	$service_user = CsServiceUsers::model()->findAllByAttributes(array('id_service'=>$v['id'],'id_dentist'=>$id_dentist));
                         	if($service_user)
                         	{ ?>
