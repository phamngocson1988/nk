    	...
    	<table class="table table-bordered">
            <thead>
        		<tr style="background-color: #f2eded;">
        			<th style="text-align: center;width:10%"><span id="abc">#</span></th>
                    <th style="text-align: center;width:30%"><span id="abc">Mã bảo hiểm</span></th>
					<th style="text-align: center;width:30%"><span id="abc">Tên bảo hiểm</span></th>
                    <th style="text-align: center;width:15%"><span id="abc">Hành động</span></th>
        		</tr>
            </thead>
            <tbody>
                <?php 
...
function deleteunit(idhead){
	...
	if(r == true){
		jQuery.ajax({
		   type:"POST",  
		   url: '<?php echo Yii::app()->baseUrl?>'+'/itemsSetting/Insurrance/Delete',
		   data:{
				"idhead":idhead, 
		   },
		   success:function(data){
