...
class FaqController extends Controller
{
    ...
    */
    ...
    public function init() {
        $this->link = Yii::app()->params['url_base_http']."/itemsPost/faq/update/id/";
    }
    ...
    */
    ...
    public function actionAjax_faq_line()
    {
        if($_POST['idtype'])
        {
          $idtype = $_POST['idtype'];

          $listline = FaqLine::model()->findAllByAttributes(array('id_faq_type'=>$idtype));

                if($listline){
                    echo "<option value='' selected='selected'>Select FAQ Line</option>";
                    foreach($listline as $temp){
