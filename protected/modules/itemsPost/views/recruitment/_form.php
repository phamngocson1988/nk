...
<div id="box_title_content" class="row clearfix" >
    ...
    <input type="file" name="Recruitment_images" id="News_images"/><br>
    <?php 
	if(isset($model->image)!="")
	{?>
    <input type="hidden" name="image_name" value="<?php echo $model->image?>">
    <img style="width:10%" id="imgUpload" src="<?php echo $baseUrl.'/upload/post/recruitment/lg/'.$model->image?>" ><br><br>
	<?php }else{?>
    <img style="width:10%" id="imgUpload" src="<?php echo $baseUrl.'/upload/post/recruitment/no_image.png'?>" ><br><br>
	<?php }?>
...
$('h1').html('');
$('.required').html('');
$("#Recruitment_postdate").datepicker({dateFormat: 'yy-mm-dd',showAnim:'fold', });
