...
<div id="box_title_content" class="row clearfix" >
    <label class="col-xs-8 col-sm-9 col-md-9">
        ...
        <?php }else{ ?>
        <h3>Update Infrastructure <?php echo $model->id; ?></h3>
        <?php } ?>     
    </label>  
...
<?php echo $form->errorSummary($model); ?>
	...
	<?php echo $form->dropDownListGroup($model,'id_type',array('widgetOptions'=>array('data'=>CHtml::listData(PInfrastructureType::model()->findAll(),'id', 'name'),'htmlOptions'=>array('empty'=>'--Choose Infrastructure Type--','required'=>'required')))); ?>
    ...
    <div class="tab-content" style="padding:15px 0;">
        ...
        <div id="n2" class="tab-pane fade in ">
          <?php echo $form->textFieldGroup($model,'title_en',array('widgetOptions'=>array('htmlOptions'=>array('maxlength'=>200)))); ?>
        </div>
    </div>
