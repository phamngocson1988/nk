...
/**
 * This is the model class for table "prices_type".
 *
 * The followings are the available columns in table 'prices_type':
 * @property integer $id
 ...
 */
class PricesType extends CActiveRecord
{
	/**
	 ...
	 * @return PricesType the static model class
	 */
