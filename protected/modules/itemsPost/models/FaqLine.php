 ...
 *
 * The followings are the available columns in table 'faq_line':
 * @property integer $id
 ...
 */
class FaqLine extends CActiveRecord
{
	/**
	...
	public function rules()
	{
		...
		return array(
			array('id_faq_type, name', 'required'),
			array('id_faq_type, status_hiden, status', 'numerical', 'integerOnly'=>true),
			array('name', 'length', 'max'=>100),
			// The following rule is used by search().
			// @todo Please remove those attributes that should not be searched.
			array('id, id_faq_type, name, status_hiden, status', 'safe', 'on'=>'search'),
		);
	}
	 ...
	 * @return FaqLine the static model class
	 */
