...
<div class="row wrapper tab-content full-height">
   ...
   <div  id="profileSideNav"  class="span1 primary-navbar col-sm-2 col-md-1">
       <ul class="nav nav-tab nav-stacked" id="myTab">    
            ...
            <li id="profile_preview_nav" class="<?php if($controller == 'group') echo "active"; ?>">
                <a href="<?php echo Yii::app()->baseUrl.'/itemsCustomers/Group/admin'; ?>">
                   <img src="<?php echo $baseUrl;?>/images/icon_sb_left/4_khach_hang/nhom_<?php if($controller == 'group'){ echo "act"; }else{ echo 'def'; } ?>.png" /> <br>
                    Nhóm
                </a>
            </li>
            
            <li id="profile_preview_nav" class="<?php if($controller == 'accounts') echo "active"; ?>">
                <a href="<?php echo Yii::app()->baseUrl.'/itemsCustomers/Accounts/admin'; ?>">
                    <img src="<?php echo $baseUrl;?>/images/icon_sb_left/4_khach_hang/khach_hang_<?php if($controller == 'accounts'){ echo "act"; }else{ echo 'def'; } ?>.png" /> <br>
                    Khách hàng 
                </a>
            </li>   

            <li id="profile_embed_nav" class="<?php if($controller == 'opportunity') echo "active"; ?>">
                <a href="<?php echo Yii::app()->baseUrl.'/itemsOpportunity/Opportunity/admin'; ?>">
                    <img src="<?php echo $baseUrl;?>/images/icon_sb_left/4_khach_hang/co_hoi_<?php if($controller == 'opportunity'){ echo "act"; }else{ echo 'def'; } ?>.png" /> <br>
                     Cơ hội
                </a>
            </li>   

            <li id="profile_configure_nav" class="<?php if($controller == 'potential') echo "active"; ?>">
                <a  href="<?php echo Yii::app()->baseUrl.'/itemsCustomers/Potential/admin'; ?>">
                    <img src="<?php echo $baseUrl;?>/images/icon_sb_left/4_khach_hang/tiem_nang_<?php if($controller == 'potential'){ echo "act"; }else{ echo 'def'; } ?>.png" /> <br>
                    Tiềm năng
                </a>
            </li> 
