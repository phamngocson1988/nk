...
{ 
    ...
    { 
        ...
        return array( 
            array('id_quotation, id_service, id_product, id_discount, id_voucher, id_user, id_author, qty, status, flag_price', 'numerical', 'integerOnly'=>true),
            ...
            array('id, id_quotation, id_service, id_product, id_discount, id_voucher, code_service, description, id_user, id_author, create_date, confirm_date, unit_price, amount, qty, teeth, tax, status, flag_price', 'safe', 'on'=>'search'),
        ); 
    } 
    ...
    { 
        ...
        $criteria->compare('code_service',$this->description,true);
