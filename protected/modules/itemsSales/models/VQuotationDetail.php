...
{ 
    ...
    { 
        ...
        return array(	
            array('id, id_quotation, id_service, id_product, id_discount, id_voucher, id_user, qty, teeth, status', 'numerical', 'integerOnly'=>true),
            ...
            array('id, id_quotation, id_service, id_product, id_discount, id_voucher, description, id_user, user_name, create_date, unit_price, amount, qty, teeth, tax, status', 'safe', 'on'=>'search'),
        ); 
    } 
   ...
   /* public function searchQuotationDetail($curpage,$searchProduct)
    {
        ...
        $v->addSearchCondition('id', $searchProduct, true);
