<style>
    .invoice-table select.select2-hidden-accessible {bottom: 1%;}
    .invoice-table .select2-container {min-width: 10px !important;}
    .invoice-table span.select2-container--disabled span.select2-selection {background: white; border: 0;}
    .invoice-table span.select2-container--disabled span.select2-selection .select2-selection__arrow {display: none;}
    ...
    .invoice-table {padding: 0 19px;}

    .invoice-table table thead {display: table; width: 100%; table-layout: fixed;}
    .invoice-table table tbody {display: block; overflow: auto; max-height: 200px;}
    .invoice-table table tbody tr {display: table; width: 100%; table-layout: fixed;}

    .invoice-table table tr th {text-align: center; background: white; color: black !important; font-weight: bold; padding: 5px 0 7px; border-bottom: 2px solid #ccc !important;}
    .invoice-table table tr td {padding: 4px 1px !important; border: 0 !important;}

    .invoice-table table tr .form-control {padding: 6px 5px;}
    .invoice-table table tr .form-control[disabled] {background: white; border: 0; box-shadow: none; cursor: default;}
    .invoice-table table tr img {width: 17px;}
...
<div class="modal-dialog modal-lg" style="width: 1000px;">
    ...
    <div class="modal-header sHeader">
        ...
        <h3 id="modalTitle" class="modal-title">CẬP NHẬT HÓA ĐƠN</h3>
    </div>
    ...
    <div class="modal-body">
        <div class="row">
            ...
            <div class="quote_info">
                    ...
                    <?php echo $form->textFieldGroup($invoice, 'create_date', array(
                            'widgetOptions' => array(
                                'htmlOptions' => array(
                                    ...
                                    'value' => date_format(date_create($invoice['create_date']), 'd/m/Y'),
                                    'readOnly' => true
                        ))));
                    ?>
                </div>
                ...
                <div class='col-md-2'>
                    <?php echo $form->textFieldGroup($invoice, 'complete_date', array(
                            'widgetOptions' => array(
                                'htmlOptions' => array(
                                    'class' => 'frm_datepicker',
                                    'value' => date_format(date_create($invoice['complete_date']), 'd/m/Y'),
                                )
                            ),
                        ));
                    ?>
                ...
                <div class='col-md-3'>
                    <?php
                        ...
                        echo CHtml::textField('author', $this->getUserName($invoice['id_author']), array('class' => 'form-control', 'readOnly' => true));
                    ?>
                </div>
            ...
            <div class="quote_hidden">
                ...
                <input type="hidden" name="Invoice[id_group_history]" value="<?php echo $invoice['id_group_history']; ?>">
                <input type="hidden" name="Invoice[id_schedule]" value="<?php echo $id_schedule; ?>">
                <input type="hidden" name="Invoice[priceBook]" id="priceBook">
            </div>

            <div id="usProduct" class="col-md-12 product invoice-table">
            ...
            <div id="sSumo" class="col-md-12">
                <div class="row">
                    <div id="sMore" class="col-md-4">
                        <button id="InvoiceNewServices" class="btn sbtnAdd upsbtnAdd">
                    ...
                    <div id="sInvoice" class="col-md-6 pull-right">
                        <div class="col-md-12">
                            <div class="form-group">
                                ...
                                <div class='col-md-4'>
                                    <?php echo $form->textField($invoice, 'sum_amount', array('required' => true, 'readOnly' => true, 'class' => 'cal_ans autoNum form-control')); ?>
                                </div>
                                ...
                                <div class='col-md-4'>
                                    <?php echo $form->textField($invoice, 'sum_amount_usd', array('required' => true, 'readOnly' => true, 'class' => 'cal_ans autoNum form-control')); ?>
                                </div>
            ...
            <div id="sFooter" class="col-md-12">
                <div class="pull-left">
                    <!-- <button type="button" onclick="exportQuote(<?php //echo $invoice['id']; ?>);" class="btn Submit">In báo giá</button> -->
                </div>
