...
<div class="modal-dialog modal-lg" style="width: 1000px">
    <div class="modal-content">
    	<div class="modal-header sHeader">
	        ...
	        <h3 id="modalTitle" class="modal-title">Lập phiếu hủy</h3>
	    </div>
	    <div class="modal-body">
            ...
            <div class="row"> 
	            ...
	            <div class="col-md-6">
	            	...
	            	<input class="hidden" name="CancelMaterial[status]" id="CancelMaterial_status" value="3">
	            </div>
...
/***** Search nguyên vật liệu *****/	
	function listMaterial(id_repository) {
		$('.listMaterial').select2({
			...
			ajax: {
				dataType: "json",
				url: '<?php echo CController::createUrl('cancelMaterial/getListMaterial'); ?>',
				type: "post",
				delay: 1000,
...
/***** Tạo mới *****/	
	$('form#frmCreate').submit(function(e) {
		e.preventDefault();
		if(confirm("Bạn có thực sự muốn hủy những nguyên vật liệu trong phiếu này ?")) {
			...
			if (!formData.checkValidity || formData.checkValidity()) {
				...
				$.ajax({
					type: "POST",
					url: "<?php echo CController::createUrl('cancelMaterial/create')?>",
					data: formData,
