...
<div class="modal-dialog modal-lg" style="width: 1000px">
    <div class="modal-content">
    	<div class="modal-header sHeader">
	        ...
	        <h3 id="modalTitle" class="modal-title">Lập phiếu xuất sử dụng</h3>
	    </div>
	    <div class="modal-body">
            ...
            <div class="row"> 
	            ...
	            <div class="col-md-6">
	            	...
	            	<input class="hidden" name="useMaterial[status]" id="useMaterial_status" value="1">
	            </div>
	            <div class="col-xs-12 mt-30 tableMaterial create">
	                ...
	                <div class="divSum">
	                	...
	                	<input type="hidden" id="total-amount" name="useMaterial[sum_amount]" value="0">
	                </div> 
	            </div>
	            <div class="col-xs-12">
	            	<div class="row">
...
/***** Item nguyên vật liệu *****/
	...
	$(document).ready(function(){
		...
		var id_repository = $('#useMaterial_id_repository').val();
...
/***** Search nguyên vật liệu *****/	
	function listMaterial(id_repository) {
		$('.listMaterial').select2({
			...
			ajax: {
				dataType: "json",
				url: '<?php echo CController::createUrl('useMaterial/getListMaterial'); ?>',
				type: "post",
				delay: 1000,
...
/***** Tạo mới *****/	
	$('form#frmCreate').submit(function(e) {
		e.preventDefault();
		if(confirm("Bạn có thực sự muốn sử dụng những nguyên vật liệu trong phiếu này ?")) {
			...
			if (!formData.checkValidity || formData.checkValidity()) {
				...
				$.ajax({
					type: "POST",
					url: "<?php echo CController::createUrl('useMaterial/create')?>",
					data: formData,
