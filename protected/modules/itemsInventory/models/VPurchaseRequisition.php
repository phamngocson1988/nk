...
/**
 * This is the model class for table "v_purchase_requisition".
 *
 * The followings are the available columns in table 'v_purchase_requisition':
 * @property integer $id
 ...
 */
class VPurchaseRequisition extends CActiveRecord
{
	/**
	...
	public function rules()
	{
		...
		return array(
			...
			array('code, name_repository', 'length', 'max'=>255),
			array('name_user', 'length', 'max'=>128),
			array('note, create_date, update_date', 'safe'),
			// The following rule is used by search().
			// @todo Please remove those attributes that should not be searched.
			array('id, code, id_repository, name_repository, id_user, name_user, note, status, create_date, update_date', 'safe', 'on'=>'search'),
		);
	}
	 ...
	 * @return VPurchaseRequisition the static model class
	 */
