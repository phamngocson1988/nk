...
class Labo extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			array('id_group_history, id_medical_history, id_branch, id_dentist, sent_date, received_date, assign', 'required'),
			array('id_group_history, id_medical_history, id_branch, id_dentist', 'numerical', 'integerOnly'=>true),
			array('note, createdate', 'safe'),
			// The following rule is used by search().
			// @todo Please remove those attributes that should not be searched.
			array('id, id_group_history, id_medical_history, id_branch, id_dentist, sent_date, received_date, assign, note, createdate', 'safe', 'on'=>'search'),
		);
	}
