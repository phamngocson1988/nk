...
<div class="row wrapper tab-content full-height">
   ...
   <div  id="profileSideNav"  class="span1 primary-navbar col-sm-2 col-md-1">
       <ul class="nav nav-tab nav-stacked" id="myTab">    
            ...
            <li id="profile_preview_nav" class="<?php if($controller == 'segment') echo "active"; ?>">
                <a href="<?php echo Yii::app()->baseUrl.'/itemsCustomers/Segment/admin'; ?>">
                   <img src="<?php echo $baseUrl;?>/images/icon_sb_left/4_khach_hang/nhom_<?php if($controller == 'segment'){ echo "act"; }else{ echo 'def'; } ?>.png" /> <br>
                    Nhóm
                </a>
            </li>
            ...
            <li id="profile_embed_nav">
                <a href="<?php echo Yii::app()->baseUrl.'/itemsOpportunity/Opportunity/admin'; ?>">
                    <img src="<?php echo $baseUrl;?>/images/icon_sb_left/4_khach_hang/co_hoi_def.png" /> <br>
                     Cơ hội
                </a>
            </li>   
...
$( document ).ready(function() {
    ...
    $('#profileSideNav').height(windowHeight-header + 20);
    $('.customerListContainer').height(windowHeight-header + 20);
