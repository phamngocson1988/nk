...
<div class="col-md-12 ns_box">
	<div class="row">
		...
		?>
			<a href="<?php echo Yii::app()->request->baseUrl; ?>/dich-vu/<?php echo $str_type;?>/<?php echo $str_title;?>-<?php echo $item['id'];?>/lang/en"><img style="width: 100%" src="<?php echo Yii::app()->request->baseUrl; ?>/upload/post/service/
			<?php 
			if(isset($item['image']))
			{
				echo "lg/".$item['image'];
		...
		<div class="col-md-7">
			<h4><a href="<?php echo Yii::app()->request->baseUrl; ?>/dich-vu/<?php echo $str_type;?>/<?php echo $str_title;?>-<?php echo $item['id'];?>/lang/en">
				<?php $title = strip_tags($item['name_en']);
		...
		<span><img src="<?php echo Yii::app()->params['image_url']; ?>/images/cmt.png" class="cmt"></span>
			...
			<div style="color: rgb(33, 32, 32)">
				<?php $description = strip_tags($item['content_en']);
			...
			<div>
				...
				<p><a href="<?php echo Yii::app()->request->baseUrl; ?>/dich-vu/<?php echo $str_type;?>/<?php echo $str_title;?>-<?php echo $item['id'];?>/lang/en"><button type="button" class="btn btn_blue">SEE MORE</button></a></p>
			</div>
		</div>
	</div>
</div>
