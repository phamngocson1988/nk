...
<div class="container" style="margin-bottom: 20px;">
      ...
      <?php if($lang=='vi'){?>
         <p style="font-size: 20px; font-weight: bold; text-transform: uppercase;">Hình ảnh ngoại khóa NHA KHOA 2000</p>
      <?php }else{?>
          <p style="font-size: 20px; font-weight: bold;">DENTAL CLINIC ACTIVITIVES</p>
      <?php }?>
      <div id="gallery1">
