...
.ns_box_img {height: 140px;border: 0px solid rgba(204, 204, 204, 1.46);padding: 0px}
...
<?php if (!$news_line) { ?>
	<div class="col-md-offset-5 col-xs-offset-4">
		<p style="font-style: italic;font-weight: bold;">No data!</p>
	</div>
...
<div class="col-md-12 ns_box">
	<div class="row">
		<div class="col-md-4 ns_img ns_box_img">
		<?php 
			$str_title = $this->convert_vi_to_en($item['title']);
		?>
			<a href="<?php echo Yii::app()->request->baseUrl; ?>/nghe-nghiep/<?php echo $str_title?>-<?php echo $item['id']?>/lang/en"><img style="width: 100%" src="<?php echo Yii::app()->request->baseUrl; ?>/upload/post/recruitment/
			<?php 
			if(isset($item['image']))
			{
				echo "lg/".$item['image'];
		...
		<div class="col-md-8">
			<h4><a href="<?php echo Yii::app()->request->baseUrl; ?>/nghe-nghiep/<?php echo $str_title?>-<?php echo $item['id']?>/lang/en">
				<?php $title = strip_tags($item['title_en']);
			...
			<div class="ns_view">
				<span>Date <?php echo $item['createdate']; ?></span>
		...
		<span><img src="<?php echo Yii::app()->params['image_url']; ?>/images/cmt.png" class="cmt"></span>
			...
			<div style="color: rgb(33, 32, 32)">
				<?php $description = strip_tags($item['description_en']);
				...
				<p style="height:43px;"><?php echo $description; ?></p>
			</div>
			<div>
				
				<p><a href="<?php echo Yii::app()->request->baseUrl; ?>/nghe-nghiep/<?php echo $str_title?>-<?php echo $item['id']?>/lang/en"><button type="button" class="btn btn_blue">SEE MORE</button></a></p>
			</div>
		</div>
	</div>
</div>
