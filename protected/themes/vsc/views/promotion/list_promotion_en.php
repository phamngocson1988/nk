...
<div class="col-md-12 ns_box" style="margin-bottom:10px;">
	<div class="row">
		<div class="col-md-5 ns_img ns_box_img">
		<?php 
			$str_title = $this->convert_vi_to_en($item['title_en']);
		?>
			<a href="<?php echo Yii::app()->request->baseUrl; ?>/khuyen-mai/<?php echo $str_title?>-<?php echo $item['id']?>/lang/en"><img style="width: 100%" src="<?php echo Yii::app()->request->baseUrl; ?>/upload/post/promotion/
			<?php 
			if(isset($item['image']))
			{
				echo "lg/".$item['image'];
		...
		<div class="col-md-7">
			<h4><a href="<?php echo Yii::app()->request->baseUrl; ?>/khuyen-mai/<?php echo $str_title?>-<?php echo $item['id']?>/lang/en">
		...
		<span><img src="<?php echo Yii::app()->params['image_url']; ?>/images/cmt.png" class="cmt"></span>
			...
			<div style="color: rgb(33, 32, 32)">
				...
				<p style="height:46px;"><?php echo $description; ?></p>
			</div>
			<div>
				
				<p><a href="<?php echo Yii::app()->request->baseUrl; ?>/khuyen-mai/<?php echo $str_title?>-<?php echo $item['id']?>/lang/en"><button type="button" class="btn btn_blue">SEE MORE</button></a></p>
			</div>
		</div>
	</div>
</div>
