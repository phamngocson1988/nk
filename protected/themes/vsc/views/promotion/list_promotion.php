...
<div class="col-md-12 ns_box" style="margin-bottom:10px;">
	<div class="row">
		...
		?>
			<a href="<?php echo Yii::app()->request->baseUrl; ?>/khuyen-mai/<?php echo $str_title?>-<?php echo $item['id']?>/lang/vi"><img style="width: 100%" src="<?php echo Yii::app()->request->baseUrl; ?>/upload/post/promotion/
			<?php 
			if(isset($item['image']))
			{
				echo "lg/".$item['image'];
		...
		<div class="col-md-7">
			<h4><a href="<?php echo Yii::app()->request->baseUrl; ?>/khuyen-mai/<?php echo $str_title?>-<?php echo $item['id']?>/lang/vi">
		...
		<span><img src="<?php echo Yii::app()->params['image_url']; ?>/images/cmt.png" class="cmt"></span>
			...
			<div>
				<p><a href="<?php echo Yii::app()->request->baseUrl; ?>/khuyen-mai/<?php echo $str_title?>-<?php echo $item['id']?>/lang/vi"><button type="button" class="btn btn_blue">XEM THÊM</button></a></p>
			</div>
		</div>
	</div>
</div>
