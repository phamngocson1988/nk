 ...
 */
class LoginCustomerForm extends CFormModel
{
	public $username;
	public $password;
	public $rememberMe;
	...
	public function rules()
	{
		return array(
			...
			array('username, password', 'required','message'=>"Vui lòng điền thông tin"),
	...
	public function authenticate($attribute,$params)
	{
		if(!$this->hasErrors())
		{
			...
			if($this->_identity->authenticate() != CustomerIdentity::ERROR_NONE)
